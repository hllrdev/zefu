    ...
    <div class="pt-24 px-4 pb-10">
        ...
        <div class="flex justify-center">
            <div class="md:w-4/5 lg:w-3/5">
                ...
                <p class="text-center py-4 text-lg"><span class="text-8xl font-bold">1678</span>kcal</p>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <th>1</th>
                                <td>Sedentário</td>
                                <td><span>1800</span> kcal</td>
                            </tr>
                            <tr>
                                <th>2</th>
                                <td>Baixo</td>
                                <td><span>2000</span> kcal</td>
                            </tr>
                            <tr>
                                <th>3</th>
                                <td>Moderado</td>
                                <td><span>2100</span> kcal</td>
                            </tr>
                            <tr>
                                <th>4</th>
                                <td>Alto</td>
                                <td><span>2300</span> kcal</td>
                            </tr>
                            <tr>
                                <th>5</th>
                                <td>Atleta</td>
                                <td><span>2600</span> kcal</td>
                            </tr>
                        </tbody>
                    </table>
                </div>

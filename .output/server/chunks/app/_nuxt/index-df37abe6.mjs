...
import { useSSRContext, mergeProps, withCtx, createVNode, withAsyncContext, unref, createTextVNode } from 'vue';
...
import { _ as __nuxt_component_3$1 } from './Product-e132651c.mjs';
...
const _imports_0 = "" + buildAssetsURL("zeffih.d93748bc.png");
const _sfc_main$3 = {};
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-neutral-50 md:flex md:justify-center px-4 md:px-0 pt-24 md:pt-14" }, _attrs))}><div class="md:w-4/5 md:flex justify-center"><div class="flex items-center"><h1 class="text-center text-neutral">Aqui voc\xEA encontra a caixa de utens\xEDlios.</h1></div><div class="flex justify-center md:block"><img class="w-60"${ssrRenderAttr("src", _imports_0)} alt="Personagem Zeff do anime One Piece segurando Sanji em seus ombros."></div></div></div>`);
}
...
//# sourceMappingURL=index-df37abe6.mjs.map

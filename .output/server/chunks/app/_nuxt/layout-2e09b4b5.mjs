...
import { P as PageRouteSymbol, f as useRoute, i as appLayoutTransition, j as _wrapIf, L as LayoutMetaSymbol, k as useNuxtApp } from '../server.mjs';
import { useRoute as useRoute$1 } from 'vue-router';

const layouts = {
  auth: () => import('./auth-c86b5838.mjs').then((m) => m.default || m),
  error: () => import('./error-95422131.mjs').then((m) => m.default || m),
  main: () => import('./main-e68f6fb4.mjs').then((m) => m.default || m)
};
...
//# sourceMappingURL=layout-2e09b4b5.mjs.map

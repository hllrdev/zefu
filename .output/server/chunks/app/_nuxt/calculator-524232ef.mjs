  ...
  setup(__props) {
    ...
    watch(goal, () => {
      if (!formData.weight || !formData.height || !formData.age || !formData.sex) {
        appStore.setAlert(true, "warning", "Preencha todos os campos para receber a sugest\xE3o.");
        return;
      }
      macrosCalc();
    });
                ...
                createVNode("div", { class: "flex justify-center" }, [
                  createVNode("div", { class: "md:w-4/5 lg:w-3/5" }, [
                    ...
                    withDirectives(createVNode("div", { class: "pb-4" }, [
                      createVNode("h2", { class: "text-center" }, "Taxa metab\xF3lica basal (TMB)"),
                      ...
                      createVNode("p", { class: "text-justify" }, "A taxa metab\xF3lica basal corresponde ao quanto de calorias voc\xEA gasta apenas em repouso, sem contabilizar nenhuma atividade do seu dia. "),
                      createVNode("h2", { class: "text-center py-4 text-white" }, "Gasto energ\xE9tico total (GET)"),
                      createVNode("p", { class: "pb-4 text-justify" }, "O gasto energ\xE9tico total corresponde ao quanto de calorias voc\xEA gasta somando a TMB + seu n\xEDvel de atividade. Os n\xEDveis de atividade s\xE3o apenas estimativas, sendo que a mensura\xE7\xE3o do esfor\xE7o realizado \xE9 subjetivo. "),
                      createVNode("div", { class: "overflow-x-auto" }, [
                        createVNode("table", { class: "table" }, [
                          createVNode("thead", null, [
                            createVNode("tr", { class: "text-neutral-50" }, [
                              createVNode("th"),
                              createVNode("th", null, "N\xEDvel de atividade"),
                          ...
                          createVNode("tbody", null, [
                            createVNode("tr", null, [
                              ...
                              createVNode("td", null, "Sedent\xE1rio"),
                              createVNode("td", null, [
                    ...
                    createVNode("h2", { class: "text-center py-4" }, "Sugest\xE3o de macronutrientes"),
                    createVNode("p", { class: "pb-4 text-justify" }, "A sugest\xE3o de macros possui valores conservadores para um in\xEDcio de dieta, conforme progress\xE3o deve-se atualizar a quantidade em especial dos carboidratos. Ela leva em conta apenas o peso do indiv\xEDduo e seu objetivo. Dessa forma, voc\xEA pode realizar a compara\xE7\xE3o com os valores indicados pela TMB e GET e ajustar caso ache necess\xE1rio. "),
                    ...
                    createVNode("div", { class: "flex flex-wrap justify-center gap-2 pt-4 pb-8" }, [
                      ...
                      withDirectives(createVNode("input", {
                        ...
                        type: "radio",
                        value: "maintenance",
                        "aria-label": "Recomposi\xE7\xE3o corporal/Manuten\xE7\xE3o"
                      }, null, 8, ["onUpdate:modelValue"]), [
                        [vModelRadio, unref(goal)]
                      ]),
                      withDirectives(createVNode("input", {
                    ...
                    withDirectives(createVNode("div", null, [
                      ...
                      createVNode("h4", { class: "text-sm font-semibold pb-2" }, "Prote\xEDna - " + toDisplayString(unref(quantityMacros).protein) + "g/kg (" + toDisplayString(Math.round(unref(formData).weight * unref(quantityMacros).protein)) + " g)", 1),
                      withDirectives(createVNode("input", {
                        type: "range",
                        min: "0",
                        max: "8",
...
//# sourceMappingURL=calculator-524232ef.mjs.map

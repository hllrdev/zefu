      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ name: "auth" }, _attrs), {
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div><div class="flex justify-center flex-col"${_scopeId}><button type="button" class="btn btn-secondary text-neutral-50 w-full mb-4"${_scopeId}>Entrar</button></div></form><p class="text-sm text-center"${_scopeId}> Ainda n\xE3o possui uma conta? `);
            ...
            return [
              createVNode("div", null, [
                ...
                createVNode("p", { class: "text-sm text-center" }, [
                  createTextVNode(" Ainda n\xE3o possui uma conta? "),
...
//# sourceMappingURL=signin-bf7c19e6.mjs.map

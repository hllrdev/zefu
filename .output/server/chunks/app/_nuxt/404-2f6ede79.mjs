...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ name: "error" }, _attrs), {
    title: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="text-center"${_scopeId}><h1${_scopeId}>Erro 404</h1><p class="font-semibold"${_scopeId}>O recurso solicitado n\xE3o foi encontrado.</p></div>`);
      } else {
        return [
          createVNode("div", { class: "text-center" }, [
            createVNode("h1", null, "Erro 404"),
            createVNode("p", { class: "font-semibold" }, "O recurso solicitado n\xE3o foi encontrado.")
          ])
        ];
      }
    }),
...
//# sourceMappingURL=404-2f6ede79.mjs.map

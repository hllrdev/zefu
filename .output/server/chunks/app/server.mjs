import { hasInjectionContext, getCurrentInstance, inject, version, unref, computed, reactive, defineAsyncComponent, useSSRContext, h, ref, watchEffect, watch, toRef, onServerPrefetch, defineComponent, withAsyncContext, mergeProps, createVNode, resolveDynamicComponent, createApp, isRef, effectScope, isReactive, toRaw, provide, onErrorCaptured, getCurrentScope, onScopeDispose, nextTick, shallowRef, shallowReactive, isReadonly, markRaw, toRefs, isShallow, Suspense, Transition } from 'vue';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrInterpolate, ssrRenderSuspense, ssrRenderClass, ssrRenderAttr } from 'vue/server-renderer';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/recovery-3bd07ba0.mjs').then((m) => m.default || m)
  },
  {
    name: "auth-reset",
    path: "/auth/reset",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/reset-a57816bb.mjs').then((m) => m.default || m)
  },
  {
    name: "auth-signin",
    path: "/auth/signin",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/signin-bf7c19e6.mjs').then((m) => m.default || m)
  },
  {
    name: "auth-signup",
    path: "/auth/signup",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/signup-95c661f8.mjs').then((m) => m.default || m)
  },
  {
    name: "calculator",
    path: "/calculator",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/calculator-524232ef.mjs').then((m) => m.default || m)
  },
  {
    name: "errors-403",
    path: "/errors/403",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/403-ff37cc1d.mjs').then((m) => m.default || m)
  },
  {
    name: "errors-404",
    path: "/errors/404",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/404-2f6ede79.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-df37abe6.mjs').then((m) => m.default || m)
  },
  {
    name: "products-add",
    path: "/products/add",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/add-0c32986e.mjs').then((m) => m.default || m)
  },
  {
    name: "products-edit",
    path: "/products/edit",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/edit-4878d4af.mjs').then((m) => m.default || m)
  },
  {
    name: "products",
    path: "/products",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-d56b659f.mjs').then((m) => m.default || m)
  },
  {
    name: "products-list",
    path: "/products/list",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/list-17d1c03f.mjs').then((m) => m.default || m)
  },
  {
    name: "products-view",
    path: "/products/view",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/view-60f81a6b.mjs').then((m) => m.default || m)
  }
];
...
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-49bade78.mjs').then((r) => r.default));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-c9cc5bf9.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-7e42a428.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-65b4e418.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { LayoutMetaSymbol as L, PageRouteSymbol as P, _export_sfc as _, useAppStore as a, useRouter as b, createError as c, useRuntimeConfig as d, entry$1 as default, useFetch as e, useRoute as f, useAuthStore as g, __nuxt_component_1$1 as h, appLayoutTransition as i, _wrapIf as j, useNuxtApp as k, useAppConfig as l, navigateTo as n, useHead as u };

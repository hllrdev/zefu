import { hasInjectionContext, getCurrentInstance, reactive, toRef, isRef, inject, nextTick, version, unref, ref, watchEffect, watch, onServerPrefetch, computed, effectScope, markRaw, isReactive, toRaw, getCurrentScope, onScopeDispose, toRefs, shallowRef, shallowReactive, isReadonly, isShallow, defineAsyncComponent, defineComponent, withAsyncContext, mergeProps, createVNode, resolveDynamicComponent, useSSRContext, provide, h, Suspense, Transition, onErrorCaptured, createApp } from "vue";
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrInterpolate, ssrRenderClass, ssrRenderAttr, ssrRenderSuspense } from "vue/server-renderer";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/recovery-3bd07ba0.js").then((m) => m.default || m)
  },
  {
    name: "auth-reset",
    path: "/auth/reset",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/reset-a57816bb.js").then((m) => m.default || m)
  },
  {
    name: "auth-signin",
    path: "/auth/signin",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/signin-bf7c19e6.js").then((m) => m.default || m)
  },
  {
    name: "auth-signup",
    path: "/auth/signup",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/signup-95c661f8.js").then((m) => m.default || m)
  },
  {
    name: "calculator",
    path: "/calculator",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/calculator-524232ef.js").then((m) => m.default || m)
  },
  {
    name: "errors-403",
    path: "/errors/403",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/403-ff37cc1d.js").then((m) => m.default || m)
  },
  {
    name: "errors-404",
    path: "/errors/404",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/404-2f6ede79.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-df37abe6.js").then((m) => m.default || m)
  },
  {
    name: "products-add",
    path: "/products/add",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/add-0c32986e.js").then((m) => m.default || m)
  },
  {
    name: "products-edit",
    path: "/products/edit",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/edit-4878d4af.js").then((m) => m.default || m)
  },
  {
    name: "products",
    path: "/products",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-d56b659f.js").then((m) => m.default || m)
  },
  {
    name: "products-list",
    path: "/products/list",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/list-17d1c03f.js").then((m) => m.default || m)
  },
  {
    name: "products-view",
    path: "/products/view",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/view-60f81a6b.js").then((m) => m.default || m)
  }
];
...
const useAppStore = defineStore("appStore", () => {
  ...
  const setAlert = (show, type, message) => {
    alert.show = show;
    alert.type = type;
...
const useAuthStore = defineStore("authStore", () => {
    ...
    await useFetch(`${API_URL}/auth/signup`, {
      ...
      onResponse({ response }) {
        if (response.status == 409) {
          ...
          auth.user = response._data.value;
  ...
  const hasPermission = (acceptedPermissions) => {
...
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-49bade78.js").then((r) => r.default));
...
const Icon_vue_vue_type_style_index_0_scoped_c3ad5561_lang = "";
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-c3ad5561"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        style: unref(appStore).alert.show ? null : { display: "none" }
      }, _attrs))}><div class="fixed z-50 bottom-4 w-11/12 md:w-4/5 lg:w-3/5 xl:w-2/5"><div class="${ssrRenderClass([unref(appStore).alert.type == "success" ? "alert-success" : unref(appStore).alert.type == "warning" ? "alert-warning" : unref(appStore).alert.type == "info" ? "alert-info" : unref(appStore).alert.type == "error" ? "alert-error" : "", "alert rounded-md"])}"><div class="absolute top-2 right-4">`);
      ...
      _push(ssrRenderComponent(_component_Icon, {
        class: "w-8 h-auto",
        name: unref(appStore).alert.icon
      }, null, _parent));
      _push(`<span>${ssrInterpolate(unref(appStore).alert.message)}</span><progress class="progress absolute bottom-1 left-0"${ssrRenderAttr("value", unref(progress))} max="100"></progress></div></div></div>`);
    };
  }
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_Alert = __nuxt_component_0;
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-c9cc5bf9.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-7e42a428.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-65b4e418.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export {
  ...
  useRoute as f,
  useAuthStore as g,
  __nuxt_component_1$1 as h,
  appLayoutTransition as i,
  _wrapIf as j,
  useNuxtApp as k,
  useAppConfig as l,
  navigateTo as n,

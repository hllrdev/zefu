...
import { _ as _export_sfc, a as useAppStore, d as useRuntimeConfig, h as __nuxt_component_1 } from "../server.mjs";
...
import "@iconify/vue";
import "defu";
const list_vue_vue_type_style_index_0_scoped_b482803c_lang = "";
const _sfc_main = {
  __name: "list",
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ name: "main" }, _attrs), {
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="overflow-x-auto" data-v-b482803c${_scopeId}><table class="table" data-v-b482803c${_scopeId}><thead data-v-b482803c${_scopeId}><tr data-v-b482803c${_scopeId}><th data-v-b482803c${_scopeId}>Produto</th><th data-v-b482803c${_scopeId}>Ações</th></tr></thead><tbody data-v-b482803c${_scopeId}><!--[-->`);
...
//# sourceMappingURL=list-17d1c03f.js.map
